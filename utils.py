...
#----------------------------------------------------------------------------
# helper function for generating data (made by AI)
#----------------------------------------------------------------------------
...
# truncates from old_depth to new_depth, padding the difference with zeroes so 
# that calculations with original depth tensors are still valid
...
# calculates log sigs, sigs, truncated of each, and zeroed version of each for use in solver
